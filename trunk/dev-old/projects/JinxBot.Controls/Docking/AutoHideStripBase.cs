...
{
    /// <summary>
    /// Specifies an automatically-hiding tab strip.
    /// </summary>
    public abstract partial class AutoHideStripBase : Control
    {
        /// <summary>
        /// When implemented in a derived class, implements a tab.
        /// </summary>
        ...
        protected class Tab : IDisposable
        {
            ...
            /// <summary>
            /// Creates a new <see>Tab</see>.
            /// </summary>
            /// <param name="content">The content to put within the tab.</param>
            ...
            /// <summary>
            /// Gets the content within this tab.
            /// </summary>
        ...
        /// <summary>
        /// Implements a collection of <see>Tab</see> objects.
        /// </summary>
        [SuppressMessage("Microsoft.Design", "CA1034:NestedTypesShouldNotBeVisible")]
        protected sealed class TabCollection : IEnumerable<Tab>
        {
            ...
            /// <summary>
            /// Gets an enumerator of the collection items.
            /// </summary>
            /// <returns>An <see>IEnumerator(T)</see>.</returns>
            ...
            /// Gets an enumerator of the collection items.
            /// </summary>
            /// <returns>An <see>IEnumerator</see>.</returns>
            ...
            /// <summary>
            /// Gets the associated docking panel.
            /// </summary>
            ...
            /// <returns>A <see>Tab</see> at the specified index.</returns>
            ...
            /// <summary>
            /// Gets whether the collection contains the specified <see>Tab</see>.
            /// </summary>
            /// <param name="tab">The <see>Tab</see> to search for.</param>
            /// <returns><see langword="true" /> if it is contained; otherwise <see langword="false" />.</returns>
            ...
            /// Gets whether the collection contains the specified <see>Tab</see>.
            /// </summary>
            /// <param name="content">The docking content to search for.</param>
            /// <returns><see langword="true" /> if it is contained; otherwise <see langword="false" />.</returns>
            ...
            /// <summary>
            /// Gets the index of the specified <see>Tab</see> in the collection.
            /// </summary>
            /// <param name="tab">The <see>Tab</see> to find.</param>
            /// <returns>The position of the tab, or <c>-1</c> if it is not contained within the collection.</returns>
            ...
            /// <summary>
            /// Gets the index of the specified docking content in the collection.
            /// </summary>
            /// <param name="content">The docking content to search for.</param>
            /// <returns><see langword="true" /> if it is contained; otherwise <see langword="false" />.</returns>
