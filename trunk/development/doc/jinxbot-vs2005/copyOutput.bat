...
copy "%DXROOT%\Presentation\jinxbot\icons\*" Output\icons
copy "%DXROOT%\Presentation\jinxbot\scripts\*" Output\scripts
copy "%DXROOT%\Presentation\jinxbot\styles\*" Output\styles
