        ...
        private class MdiClientController : NativeWindow, IComponent, IDisposable
        {
            ...
            public BorderStyle BorderStyle
            {
                set
                {
                    ...
                    IntPtr pStyle = new IntPtr(style);
                    IntPtr pExStyle = new IntPtr(exStyle);
                    // Set the styles using Win32 calls
                    NativeMethods.SetWindowLongPtr(MdiClient.Handle, (int)GetWindowLongIndex.GWL_STYLE, pStyle);
                    NativeMethods.SetWindowLongPtr(MdiClient.Handle, (int)GetWindowLongIndex.GWL_EXSTYLE, pExStyle);
